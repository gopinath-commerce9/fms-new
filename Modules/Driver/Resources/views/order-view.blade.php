    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-custom overflow-hidden">
                ...
                <form action="{{ url('/driver/order-status-change/' . $saleOrderData['id']) }}" method="POST" id="order_view_status_change_form">
                    @csrf
                        ...
                        <div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
                            <div class="col-md-11">
                                <div class="d-flex justify-content-between">
                                    <?php if($saleOrderData['order_status'] === \Modules\Sales\Entities\SaleOrder::SALE_ORDER_STATUS_READY_TO_DISPATCH) { ?>
                                        ...
                                        <div class="row">
                                            <div class="col col-12">
                                                <table class="table table-borderless">
                                                    <tr>
                                                        <td>
                                                            <select class="form-control" name="sale_order_status" id="sale_order_status">
                                                                ...
                                                                <option value="{{ \Modules\Sales\Entities\SaleOrder::SALE_ORDER_STATUS_OUT_FOR_DELIVERY }}">
                                                                    {{ $orderStatuses[\Modules\Sales\Entities\SaleOrder::SALE_ORDER_STATUS_OUT_FOR_DELIVERY] }}
                                                                </option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="{{ url('/driver/print-shipping-label/' . $saleOrderData['id']) }}" class="btn btn-primary font-weight-bold">Print Shipping Label</a>
                                                        </td>
                                                        <td>
                                                            <a href="{{ url('/driver/print-order-invoice/' . $saleOrderData['id']) }}" class="btn btn-primary font-weight-bold">Print Invoice</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                    ...
                                    <?php } elseif ($saleOrderData['order_status'] === \Modules\Sales\Entities\SaleOrder::SALE_ORDER_STATUS_OUT_FOR_DELIVERY) { ?>
...
@section('custom-js-section')
    ...
    <script>
        jQuery(document).ready(function() {
            DriverCustomJsBlocks.orderViewPage('{{ url('/') }}');
        });
    </script>
