                    ...
                    <div class="card-toolbar w-100">
                        ...
                        <div class="col text-right">
                            @if(in_array($saleOrderData['order_status'], array_keys($resyncStatuses)))
                                <a href="{{ url('/supervisor/order-resync/' . $saleOrderData['id']) }}" id="order_resync_btn" class="btn btn-primary">
                                ...
                                <div class="table-responsive">
                                    <table class="table text-md-right">
                                        <tbody>
                                            ...
                                            @if(!is_null($saleOrderData['store_credits_used']))
                                            <tr>
                                                <td></td>
                                                <td class="align-middle title-color border-0 pl-0 w-50">Store Credits Used</td>
                                                <td class="text-danger border-0 py-7"><?php echo $saleOrderData['order_currency'] . " " . $saleOrderData['store_credits_used'];?></td>
                                            </tr>
                                            @endif
...
@section('custom-js-section')
    ...
    <script>
        jQuery(document).ready(function() {
            SupervisorCustomJsBlocks.orderViewPage('{{ url('/') }}', '{{ $saleOrderData['id'] }}');
        });
    </script>
